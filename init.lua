    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gri', function()
            require('telescope.builtin').lsp_implementations { jump_type = 'tab drop' }
          ...
          map('gO', function()
            require('telescope.builtin').lsp_document_symbols { jump_type = 'tab drop' }
          end, 'Open Document Symbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map('gW', function()
            require('telescope.builtin').lsp_dynamic_workspace_symbols { jump_type = 'tab drop' }
          ...
          map('grt', function()
            require('telescope.builtin').lsp_type_definitions { jump_type = 'tab drop' }
